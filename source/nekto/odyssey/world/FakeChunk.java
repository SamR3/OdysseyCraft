...
public class FakeChunk extends Chunk {
    ...
    {
        return ((WorldGrid)(worldObj)).getSavedLightValue(enumskyblock, i, j, k);
    }
    ...
    {
        int i1 = worldObj.provider.hasNoSky ? 0 : ((WorldGrid)(worldObj)).getSavedLightValue(EnumSkyBlock.Sky, i, j, k);
        if(i1 > 0)
        {
            isLit = true;
        }
        i1 -= l;
        int j1 = ((WorldGrid)(worldObj)).getSavedLightValue(EnumSkyBlock.Block, i, j, k);
        if(j1 > i1)
        {
            i1 = j1;
        }
